...
@Database(entities={FavouriteEventDatabaseTable.class,TourDayUserDatabaseTable.class,ProductWishListDatabaseTable.class,ShopCartTable.class},version = 6,exportSchema = false)
