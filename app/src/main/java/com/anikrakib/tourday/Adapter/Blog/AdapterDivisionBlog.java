...
public class AdapterDivisionBlog extends RecyclerView.Adapter<AdapterDivisionBlog.BlogViewHolder> {
    private Context mContext;
    private ArrayList<BlogItem> mBlogItemList;
    Context context;
    Dialog myDialog;

    public AdapterDivisionBlog(Context mContext, ArrayList<BlogItem> mBlogItemList) {
    ...
    @NonNull
    @Override
    public AdapterDivisionBlog.BlogViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.list_blog_item, parent, false);
        return new AdapterDivisionBlog.BlogViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterDivisionBlog.BlogViewHolder holder, int position) {
