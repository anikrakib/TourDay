...
public class AdapterGoingUserEvent extends RecyclerView.Adapter<AdapterGoingUserEvent.MyViewHolder>{

    Context context ;
    List<GoingUser> mData;


    public AdapterGoingUserEvent(Context context, List<GoingUser> mData) {
